...
class BusinessBookingService:
    ...
    def _generate_time_slots(
        ...
        while (current_time + service_duration) <= next_time:
            ...
            current_time = service_end_time + timedelta(minutes=interval_minutes)
    ...
    def get_staff_time_slots(self, staff_id, service_ids, appointment_date, service_duration):
        try:
            ...
            staff_working_hours = self._get_staff_working_hours(staff_id, appointment_date)
            ...
            for booked_time_slot in booked_time_slots:
                booked_start_time = booked_time_slot.start_at.astimezone(time_zone).time()
                booked_end_time = booked_time_slot.end_at.astimezone(time_zone).time()
                booked_start_time = timedelta(hours=booked_start_time.hour, minutes=booked_start_time.minute)
                booked_end_time = timedelta(hours=booked_end_time.hour, minutes=booked_end_time.minute)
