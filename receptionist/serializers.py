...
class AIConfigurationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'language', 'voice', 'model_name',
            'temperature', 'created_at', 'updated_at', 'status',
            'prompt'
        ]
...
class ConversationMessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'call', 'call_sid', 'role', 'content', 'timestamp',
            'confidence_score'
        ]
...
class IntentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Intent
        fields = [
            'id', 'call', 'call_sid', 'name', 'confidence', 
...
class AudioRecordingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'call', 'call_sid', 'audio_url', 'duration_seconds',
...
class SystemLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SystemLog
        fields = [
            'id', 'call', 'call_sid', 'level', 'message', 
            'metadata', 'created_at'
        ]
        read_only_fields = ['id', 'created_at']
...
class CallSessionDetailSerializer(CallSessionSerializer):
    ...
    class Meta(CallSessionSerializer.Meta):
        fields = CallSessionSerializer.Meta.fields + [
            'messages', 'intents', 'recordings', 'logs'
        ]
